...
alias editutils='vim $HOME/dotfiles/shellutils.sh && source $HOME/dotfiles/shellutils.sh'
alias editenv='vim $HOME/dotfiles/shellenv.sh && source $HOME/dotfiles/shellenv.sh'
